...
echo Launching P40 (GPU 1, --high)...
start "Keryx P40" cmd /c ^
  "set CUDA_VISIBLE_DEVICES=1 && set PATH=%CUDA_BIN%;%%PATH%% && set KERYX_CUDA_DEVICE=1 && cd /d %~dp0run\p40 && keryx-miner.exe -a %MINING_ADDRESS% -s grpc://127.0.0.1:22110 --high --no-legacy && pause"
